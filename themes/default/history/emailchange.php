...
<h2><?php echo htmlspecialchars(Athena::message('HistoryEmailHeading')) ?></h2>
<?php if ($changes): ?>
<?php echo $paginator->infoText() ?>
<table class="horizontal-table">
	<tr>
		<th><?php echo $paginator->sortableColumn('request_date', Athena::message('HistoryEmailRequestDate')) ?></th>
		<th><?php echo $paginator->sortableColumn('request_ip', Athena::message('HistoryEmailRequestIp')) ?></th>
		<th><?php echo $paginator->sortableColumn('old_email', Athena::message('HistoryEmailOldAddress')) ?></th>
		<th><?php echo $paginator->sortableColumn('new_email', Athena::message('HistoryEmailNewAddress')) ?></th>
		<th><?php echo $paginator->sortableColumn('change_date', Athena::message('HistoryEmailChangeDate')) ?></th>
		<th><?php echo $paginator->sortableColumn('change_ip', Athena::message('HistoryEmailChangeIp')) ?></th>
	</tr>
...
<?php else: ?>
<p>
	<?php echo htmlspecialchars(Athena::message('HistoryNoEmailChanges')) ?>
