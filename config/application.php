...
return array(
	...
	'PasswordEncodingSHA'  => true,                     // Encode password with SHA1.
	'PasswordEncodingMD5'  => false,                    // Encode password with MD5 (PasswordEncodingSHA takes precedence).
	'BirthdateStartYear'   => 1950,                     // Oldest year player can select for their birthday.
	'BirthdateAgeRestrict' => 0,                        // Minimum age restriction. Default: 0/none
	...
	'MenuItems' => array(
		...
		'CP Account'   => array(
			'My Account'    => array('module' => 'cluster', 'action' => 'view'),
			'Register'      => array('module' => 'cluster', 'action' => 'create'),
			'Login'         => array('module' => 'cluster', 'action' => 'login'),
			'Logout'        => array('module' => 'cluster', 'action' => 'logout'),
		),
		'Donations'   => array(
	...
	'SubMenuItems' => array(
		...
		'cluster' => array(
			'login'      => 'Login',
			'create'     => 'Register',
			'index'      => 'List Cluster Accounts',
			'view'       => 'View Cluster Accounts',
			'link'       => 'Add a In-Game Account',
			'create'     => 'Create In-Game Account',
			'changepass' => 'Change Cluster Password',
			'changemail' => 'Change Cluster E-mail',
			'resetpass'  => 'Reset Cluster Password',
		),
		'account' => array(
			'index'      => 'List Accounts',
			'view'       => 'View Account',
...
//		'AccountCreateTable'  => 'cp_createlog', -- TODO
		...
		'ClusterTable'        => 'cp_account',
		'ClusterLinksTable'   => 'cp_acclinks'
	)
);
?>
